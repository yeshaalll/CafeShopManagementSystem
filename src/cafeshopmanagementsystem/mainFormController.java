...
public class mainFormController implements Initializable {
    ...
    public void menuReceiptBtn() {
        ...
        if (totalP == 0 || menu_amount.getText().isEmpty()) {
            ...
            try {
                ...
                JasperDesign jDesign = JRXmlLoader.load("C:\\Users\\Yesha\\Documents\\NetBeansProjects\\CafeShopManagementSystem-main\\CafeShopManagementSystem-main\\cafeShopManagementSystem\\src\\cafeshopmanagementsystem\\report.jrxml");
    ...
    public void menuRestart() {
        ...
        change = 0;
        amount = 0;
        menu_total.setText("Rp.0");
        menu_amount.setText("Rp.0");
    ...
    public void logout() {
        ...
        try {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                stage.setTitle("MB Cafe Management System");
